...
client = QdrantClient(
    url ="https://c8abf992-e97b-4ccd-a2b0-046e5c9f5ee5.europe-west3-0.gcp.cloud.qdrant.io",
...
# client.add(
#     collection_name= "cool_movies",
#     documents = [i["description"] for i in documents],
#     metadata=documents,
...
for hit in hits:
    print(hit.metadata, "Score: ", hit.score)